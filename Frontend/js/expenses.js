...
function downloadExpensesExcel() {
    ...
    exportToExcel('eDESK_Expenses_' + document.getElementById('fStart').value + '_to_' + document.getElementById('fEnd').value + '.csv', ['Date', 'Title', 'Category', 'Amount', 'Recorded By', 'Note'], rows);
}